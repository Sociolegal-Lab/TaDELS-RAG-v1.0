...
以下為各繳交者於 test split（101 題）的評估結果，依**總分**由高至低排序。各指標說明請見上方「評分機制」。

| 排名 | 繳交者／模型 | 總分 | 實體比對 | nDCG@5 | 幻覺率 | 短答 | 長答 | 不可回答 |
| ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 周穆可／Claude Sonnet 4.6 | 0.9267 | 0.9353 | 0.9657 | 0.0294 | 0.9706 | 0.9000 | 0.9091 |
| 2 | 周穆可／Gemma 4 31B | 0.9192 | 0.9095 | 0.9763 | 0.0418 | 0.9706 | 0.8483 | 0.9394 |
| 3 | 周穆可／GPT 5.5 | 0.8836 | 0.8417 | 0.9755 | 0.0343 | 0.9169 | 0.7666 | 0.9697 |
| 4 | 周穆可／Nemotron 3 33B | 0.8155 | 0.8584 | 0.9712 | 0.0876 | 0.9559 | 0.7609 | 0.7273 |
| 5 | 周穆可／Mistral Small 3.2 24B | 0.8126 | 0.7657 | 0.6517 | 0.1820 | 0.8532 | 0.6782 | 0.9091 |
| 6 | 黃鈞喆／Gemma 4 31B | 0.7661 | 0.6821 | 0.9608 | 0.0154 | 0.8591 | 0.5050 | 0.9394 |
| 7 | 侯欽佑／Gemma 4 31B | 0.7125 | 0.6024 | 0.8580 | 0.0223 | 0.8138 | 0.3911 | 0.9394 |

> 短答、長答以實體比對分數計分；不可回答以完全比對計分。幻覺率越低越好。
