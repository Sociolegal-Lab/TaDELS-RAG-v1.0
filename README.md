...
| 指標   | 適用題型                   | 指標說明                                                                                                                     |
| ------ | -------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| nDCG@5 | 短答題、長答題、不可回答題 | 衡量系統回傳的前五篇文書是否包含標準答案來源或同案件關聯文書，且相關文書是否排序在前；分數越高，表示檢索結果越能支持後續作答 |

### 生成品質

本研究採實體導向評估，參考 Pradeep 等人提出的 nugget-based evaluation（資訊單元評估）概念，將完整答案拆成可檢查的資訊單元。於本資料集中，資訊單元具體化為法律實體欄位；短答題與長答題以實體比對分數（Entity Matching Score）評估，不可回答題以完全比對（Exact Match）評估，並另計幻覺相關指標。
...
以下為各繳交者於 test split 的評估結果，依 **Total** 由高至低排序，欄位與線上排行榜一致。各指標說明請見上方「評分機制」。

下表 nDCG@5 屬**檢索品質（Retrieval Quality）**；Total、Entity Matching Score、Hallucination Penalty、Hallucination Rate 屬**生成品質（Generation Quality）**。

| # | Name/Model | nDCG@5 | Total | Entity Matching Score | Hallucination Penalty | Hallucination Rate | N |
| ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 周穆可/Claude Sonnet 4.6 | 0.9763 | 0.9480 | 0.9521 | 0.0250 | 0.0524 | 101 |
| 2 | test | 0.9763 | 0.9480 | 0.9521 | 0.0250 | 0.0524 | 101 |
| 3 | 周穆可/Gemini Pro 3.1 | 0.9755 | 0.9190 | 0.8796 | 0.0147 | 0.0423 | 101 |
| 4 | 周穆可/Gemma 4 31B | 0.9763 | 0.9174 | 0.9067 | 0.0147 | 0.0396 | 101 |
| 5 | 周穆可/GPT 5.5 | 0.9755 | 0.8815 | 0.8386 | 0.0081 | 0.0326 | 101 |
| 6 | 周穆可/Nemotron 3 33B | 0.9712 | 0.8132 | 0.8549 | 0.0691 | 0.0845 | 101 |
| 7 | 周穆可/Mistral Small 3.2 24B | 0.6480 | 0.8029 | 0.7513 | 0.2176 | 0.2009 | 101 |
| 8 | 黃鈞喆/Gemma4 31b | 0.9608 | 0.7399 | 0.6430 | 0.0081 | 0.0154 | 101 |
| 9 | 侯欽祐/Gemma 4 31b | 0.8550 | 0.7011 | 0.5855 | 0.0147 | 0.0258 | 101 |
