...
| 指標                  | 使用欄位               | 適用題型       | 分數意義                                                                                                                                             |
| --------------------- | ---------------------- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Entity Matching Score | `entities`           | 短答題、長答題 | 主要生成分數。系統輸出的法律實體會逐欄位與標準答案比對；分數越高，表示答案越能正確呈現原始文書中的關鍵法律資訊                                       |
...
| Exact Match           | `answer`             | 不可回答題     | 判斷系統是否正確表示「無法從文件判斷」；此指標用於評估系統面對資料不足問題時是否能拒答，而不是編造答案                                               |
